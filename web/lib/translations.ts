...
export const translations = {
  ...
  nav: {
    ...
    cta:       { fr: "Démarrer gratuitement →", en: "Get started free →" },
  },

  // ── Hero ─────────────────────────────────────────────────────────────────────
  hero: {
    badge:    { fr: "Conçu pour les propriétaires nord-américains", en: "Built for North American landlords" },
    h1a:      { fr: "Maximisez vos revenus.", en: "Maximize your rental income." },
    h1b:      { fr: "Zéro complication.", en: "Zero hassle." },
    sub:      {
      fr: "Collecte des loyers, hausses automatiques, modèles de baux provinciaux et conseiller IA. Tout ce dont vous avez besoin pour gérer votre portefeuille, en une seule application.",
      en: "Rent collection, automatic increases, provincial lease templates, and an AI advisor. Everything you need to run your portfolio, in one app.",
    },
    cta1:     { fr: "Commencer gratuitement", en: "Get started free" },
    cta2:     { fr: "Voir comment ça marche", en: "See how it works" },
    social:   { fr: " propriétaires nous font déjà confiance", en: " landlords already trust us" },
    badge1:   { fr: "Zéro retard de loyer", en: "Zero late payments" },
    badge2:   { fr: "Baux provinciaux prêts en 2 min", en: "Provincial leases in 2 min" },
    badge3:   { fr: "IA qui répond en secondes", en: "AI that answers in seconds" },
    stat1v:   { fr: "14 jours", en: "14 days" },
    stat1l:   { fr: "Essai gratuit, sans carte", en: "Free trial, no card" },
    stat2v:   { fr: "0 $", en: "$0" },
    stat2l:   { fr: "Frais cachés facturés", en: "Hidden fees charged" },
    stat3v:   { fr: "500h+", en: "500h+" },
    stat3l:   { fr: "Redonnées aux propriétaires", en: "Given back to landlords" },
  ...
  ai: {
    ...
    cta: { fr: "Essayer Domely AI →", en: "Try Domely AI →" },
  },
  ...
  compare: {
    ...
    sub:    {
      fr: "On a aligné les 4 leaders du marché nord-américain. Domely coche chaque case, au prix le plus bas.",
      en: "We lined up the 4 top North American tools. Domely checks every box, at the lowest price.",
    },
    cols:   {
    ...
    rows: [
      { feature: { fr: "Application mobile native",        en: "Native mobile app" },              domely: true,  buildium: true,             building: true,              turbotenant: "partial" as const },
      { feature: { fr: "Calcul de hausse locative auto",   en: "Auto rent increase calculator" },   domely: true,  buildium: false,            building: false,             turbotenant: false },
      { feature: { fr: "Génération de baux automatique",   en: "Automatic lease generation" },      domely: true,  buildium: true,             building: "partial" as const, turbotenant: true },
      { feature: { fr: "Conseiller IA inclus",             en: "AI advisor included" },             domely: true,  buildium: false,            building: false,             turbotenant: false },
      { feature: { fr: "Interface bilingue FR/EN",         en: "Bilingual FR/EN interface" },       domely: true,  buildium: false,            building: "partial" as const, turbotenant: false },
      { feature: { fr: "Données de marché locatif",        en: "Rental market data" },              domely: true,  buildium: false,            building: false,             turbotenant: false },
      { feature: { fr: "Portail locataire",                en: "Tenant portal" },                   domely: true,  buildium: true,             building: true,              turbotenant: true },
      { feature: { fr: "Prix affiché en ligne",            en: "Transparent pricing online" },      domely: true,  buildium: true,             building: "partial" as const, turbotenant: true },
      { feature: { fr: "Gratuit pour 1–2 logements",      en: "Free for 1–2 units" },              domely: true,  buildium: false,            building: "partial" as const, turbotenant: "partial" as const },
      { feature: { fr: "Données hébergées en Amérique du Nord", en: "Data hosted in North America" }, domely: true,  buildium: false,            building: "partial" as const, turbotenant: false },
    ] as Array<{ feature: { fr: string; en: string }; domely: boolean | "partial"; buildium: boolean | "partial"; building: boolean | "partial"; turbotenant: boolean | "partial" }>,
    ctaNotes: {
    ...
    plans: ([
      {
        ...
        desc: { fr: "Parfait pour démarrer avec 1 ou 2 logements.", en: "Perfect for getting started with 1 or 2 units." },
        cta:  { fr: "Démarrer gratuitement", en: "Get started free" },
        features: [
          { fr: "1 immeuble · jusqu'à 2 logements", en: "1 property · up to 2 units" },
      ...
      },
      {
        ...
        features: [
          ...
          { fr: "Export CSV & PDF",                           en: "CSV & PDF export" },
          { fr: "Portail locataire complet",                  en: "Full tenant portal" },
  ...
  cta: {
    ...
    cta1:  { fr: "Créer mon compte gratuit", en: "Create my free account" },
  ...
  footer: {
    ...
    links: {
      ...
      company: [
        { fr: "Mission",    en: "Mission",    href: "/mission" },
        { fr: "À propos",   en: "About",      href: "/about" },
        { fr: "Blog",       en: "Blog",       href: "/blog" },
      ],
      resources: [
        { fr: "Guide de gestion locative", en: "Rental management guide",   href: "/guide" },
        { fr: "Données de marché",     en: "Market data",      href: "/#features" },
